...
export const writeSectionEQ = [
  { id: 86, question: 'ข้อ 86. คำใดเขียนถูกต้อง ?', options: [{ text: 'ก. โลกาภิวัตน์', correct: true }, { text: 'ข. โลกาภิวัฒน์', correct: false }], meaning: 'หมายถึง การแพร่กระจายไปทั่วโลก การที่ประชาคมโลกไม่ว่าจะอยู่ ณ จุดใด สามารถรับรู้ สัมพันธ์ หรือรับผลกระทบจากสิ่งที่เกิด' },
  { id: 87, question: 'ข้อ 87. คำใดเขียนถูกต้อง ?', options: [{ text: 'ก. ประดิดประดอย', correct: true }, { text: 'ข. ประดิษฐ์ประดอย', correct: false }], meaning: 'หมายถึง บรรจงทำให้งดงามและละเอียดลออยิ่งขึ้น' },
  { id: 88, question: 'ข้อ 88. คำใดเขียนถูกต้อง ?', options: [{ text: 'ก. เกษียณอายุ', correct: true }, { text: 'ข. เกษียนอายุ', correct: false }], meaning: 'หมายถึง สิ้นไป ใช้เกี่ยวกับการกำหนดอายุของการทำงาน' },
  { id: 89, question: 'ข้อ 89. คำใดเขียนถูกต้อง ?', options: [{ text: 'ก. เลือดกบปาก', correct: true }, { text: 'ข. เลือดกลบปาก', correct: false }], meaning: 'หมายถึง มีเลือดออกเต็มปาก' },
  { id: 90, question: 'ข้อ 90. คำใดเขียนถูกต้อง ?', options: [{ text: 'ก. อเนกประสงค์', correct: true }, { text: 'ข. เอนกประสงค์', correct: false }], meaning: 'หมายถึง ใช้ประโยชน์ได้หลายอย่างแล้วแต่ความต้องการ' },
];

export const rearrangePart5Q = [
  { id: 91, words: ['ข้าวเหนียว', 'อามีน', 'ไก่ย่าง', 'กิน', 'และ', 'มุนี'], answer: 'อามีนและมุนีกินข้าวเหนียวไก่ย่าง' },
  { id: 92, words: ['ชอบ', 'ข้าวยำ', 'ขาย', 'อาหมัด', 'กิน', 'พ่อของมีนา', 'มาก', 'ข้าวยำ', 'จึง'], answer: 'อาหมัดพ่อของมีนาชอบกินข้าวยำมากจึงขายข้าวยำ' },
  { id: 93, words: ['ก็', 'สอบไม่ผ่าน', 'ใคร ๆ', 'ต้อง', 'มิฉะนั้น', 'ก็', 'ช่วยตัวเอง'], answer: 'ใคร ๆก็ต้องช่วยตัวเองมิฉะนั้นก็สอบไม่ผ่าน' },
  { id: 94, words: ['รางวัล', 'เด็ก', 'ของสังคม', 'เป็น', 'จิตอาสา', 'คนดี', 'ได้รับ', 'เพราะ'], answer: 'เด็กจิตอาสาได้รับรางวัลเพราะเป็นคนดีของสังคม' },
  { id: 95, words: ['ศูนย์ส่งเสริมการเรียนรู้ระดับอำเภอ', 'เพื่อน', 'ฉัน', 'ไป', 'สมัคร', 'และ', 'ที่', 'เรียน'], answer: 'ฉันและเพื่อนไปสมัครเรียนที่ศูนย์ส่งเสริมการเรียนรู้ระดับอำเภอ' },
  { id: 96, words: ['ฉัน', 'ถึง', 'รัก', 'เขา', 'ก็', 'แต่', 'จะ', 'แก่'], answer: 'ถึงเขาจะแก่แต่ฉันก็รัก' },
];
