...
export const PASSAGE_F = `"สิ่งแวดล้อมทางธรรมชาติมีความสำคัญต่อการดำรงชีวิตของมนุษย์อย่างมาก ทั้งอากาศบริสุทธิ์ น้ำสะอาด และพื้นที่สีเขียวล้วนเป็นปัจจัยพื้นฐานที่ช่วยรักษาสุขภาพของเราได้ อย่างไรก็ตาม ในปัจจุบันสิ่งแวดล้อมกำลังถูกทำลายด้วยน้ำมือมนุษย์ ไม่ว่าจะเป็นมลพิษทางอากาศจากการเผาไหม้ น้ำเสียจากโรงงานอุตสาหกรรม หรือการตัดไม้ทำลายป่า ดังนั้น ทุกคนควรมีส่วนร่วมในการอนุรักษ์สิ่งแวดล้อม เพื่อให้โลกใบนี้ยังคงเป็นที่อยู่อาศัยที่ดีสำหรับคนรุ่นต่อไป"`;

export const sectionFQ = [
