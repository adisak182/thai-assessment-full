...
export const introQ = [
  { id: 26, audio: '/audio/spk_q26.mp3', question: '"สวัสดีค่ะ คุณชื่ออะไรคะ"', hint: 'บอกชื่อ-นามสกุล และชื่อเล่นอย่างเป็นทางการ', keywords: [] },
  { id: 27, audio: '/audio/spk_q27.mp3', question: '"คุณเป็นคนที่ไหนคะ (บ้านเกิดอยู่ที่ไหน)"', hint: 'บอกชื่อจังหวัด หรืออำเภอที่ตนเองเติบโตมา', keywords: [] },
  { id: 28, audio: '/audio/spk_q28.mp3', question: '"คุณเรียนจบระดับไหน และจบจากที่ไหนมาคะ"', hint: 'ระบุระดับการศึกษาล่าสุด หรือสถานศึกษาที่จบมา', keywords: [] },
  { id: 29, audio: '/audio/spk_q29.mp3', question: '"ตอนนี้คุณทำงานอะไร หรือทำอาชีพอะไรอยู่คะ"', hint: 'บอกตำแหน่งงาน หน่วยงาน หรือลักษณะงานที่ทำ', keywords: [] },
  { id: 30, audio: '/audio/spk_q30.mp3', question: '"เวลาว่างคุณชอบทำกิจกรรมอะไรมากที่สุดคะ"', hint: 'อธิบายสิ่งที่ชอบทำ พร้อมให้เหตุผลสั้น ๆ ได้', keywords: [] },
];

export const situQ = [
  { id: 31, audio: '/audio/spk_q31.mp3', situation: 'ซื้อของในร้าน', prompt: 'แม่ค้า: "ลูกค้าต้องการซื้ออะไรคะ"', hint: 'ตอบด้วยชื่อสินค้าที่ต้องการซื้อ', keywords: [] },
  { id: 32, audio: '/audio/spk_q32.mp3', situation: 'หลงทาง', prompt: 'ป้าอ้อย: "ขอโทษค่ะ ช่วยบอกทางไปโรงพยาบาลได้ไหมคะ"', hint: 'ตอบด้วยการบอกทาง เช่น เลี้ยวซ้าย ตรงไป', keywords: ['เลี้ยว', 'ตรง', 'ซ้าย', 'ขวา', 'เดิน', 'ขับ'] },
  { id: 33, audio: '/audio/spk_q33.mp3', situation: 'ไปพบหมอที่โรงพยาบาล', prompt: 'หมอ: "วันนี้คนไข้มีอาการอย่างไรคะ"', hint: 'บอกอาการที่รู้สึก เช่น ปวดหัว มีไข้ เป็นต้น', keywords: ['ปวด', 'เจ็บ', 'ไข้', 'ไอ', 'น้ำมูก', 'เวียน', 'ร้อน', 'หนาว'] },
  { id: 34, audio: '/audio/spk_q34.mp3', situation: 'ชวนเพื่อนไปทำกิจกรรมจิตอาสา', prompt: 'เพื่อน: "เราต้องเตรียมอุปกรณ์อะไรบ้างในการทำกิจกรรมจิตอาสา"', hint: 'บอกวัสดุอุปกรณ์ในการทำความสะอาด เช่น ไม้กวาด ถุงขยะ', keywords: ['กวาด', 'ขยะ', 'ถุง', 'ไม้', 'ถัง', 'น้ำ', 'เช็ด', 'ถู'] },
  { id: 35, audio: '/audio/spk_q35.mp3', situation: 'นัดเพื่อนทำการบ้าน', prompt: 'เพื่อน: "พรุ่งนี้เรานัดทำการบ้านที่ไหนดี"', hint: 'บอกสถานที่ เช่น ห้องสมุด บ้าน ร้านกาแฟ', keywords: ['บ้าน', 'ห้องสมุด', 'โรงเรียน', 'ร้าน', 'คาเฟ่'] },
];
